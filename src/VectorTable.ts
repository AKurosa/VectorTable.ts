...
class VectorTable{
     ...
     * @param  {number} numHeaderRow
     */
    createAndAppendHeaderFrame(svg: HTMLElement, setting: SettingVectorTable, cellDataMatrix: CellSize[][], asp: number, svgSize: SvgSize, numHeaderRow: number){
        // row
        if(setting.row_dir_line){
            if(setting.header_row){
                let line = document.createElementNS(theXmlns, "line");
     ...
     * @param  {number} asp
     */
    createAndAppendOuterFrame(svg: HTMLElement, setting: SettingVectorTable, svgSize: SvgSize, asp: number){
        if(setting.outer_frame){
            if(setting.row_dir_line){
...
class VectorTableSetting{
     ...
     */
    genDefaultSetting(settingName: string): object{
        switch(settingName){
